...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// So, we allow :focus to index through QSA all the time to avoid the IE error
...
jQuery.event = {
	...
	trigger: function( event, data, elem, onlyHandlers ) {
		...
		// Caller can index in a jQuery.Event object, Object, or just an event type string
		...
		for ( ; i < l; i++ ) {
			for ( cur = this[i]; cur && cur !== context; cur = cur.parentNode ) {
				...
				if ( cur.nodeType < 11 && (pos ?
					...
					// Don't index non-elements to Sizzle
					cur.nodeType === 1 &&
