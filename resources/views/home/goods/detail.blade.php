					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="{{asset($detail->gpic)}}"><img src="{{asset($detail->gpic)}}" alt="细节展示放大镜特效" rel="{{asset($detail->gpic)}}" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="{{asset($detail->gpic)}}" mid="{{asset($detail->gpic)}}" big="{{asset($detail->gpic)}}"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>价格</dt>
									<dd><em>¥</em><b class="sys_item_price">{{$detail->price}}</b>  </dd>                                 
								</li>
								
								<li class="price iteminfo_mktprice">
									<dt>描述</dt>
									<dd><b class="gold-list" >{{$detail->gdesc}}</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
											...
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															<input id="min" onclick="aaa({{$id}})" class="am-btn am-btn-default" name="" type="button"  value="-" />
															<input id="text_box" onchange="bbb({{$id}})" name="bcnt" type="text" value="1" style="width:30px;" />
															<input id="add" class="am-btn am-btn-default" name="" type="button" value="+" onclick="ccc({{$id}})"/>
															<span id="Stock" class="tb-hidden">库存<span class="stock">{{$detail->stock}}</span>件</span>
														</dd>
											<script type="text/javascript">
												function aaa(id){
													 ...
													 num--;
													var a = $('#LikBasket');
													 a.attr('href',"{{url('home/cart/')}}/"+id+'?num='+num);
												}
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket"  title="加入购物车" href="{{url('home/cart/').'/'.$id}}?num=1" ><i></i>加入购物车</a>
								</div>
							</li>
						</div>
