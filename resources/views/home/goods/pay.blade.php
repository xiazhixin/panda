		...
		<div class="am-container header">
			...
			<div class="concent">
				...
				<div class="paycont">
                   ...
                   <span class="buy-user">{{$user['rec']}} </span>
										<span class="buy-phone">{{$user['tel']}}</span>
										</span>
									</div>
									<div class="default-address DefaultAddr">
										...
										<span class="street">{{$user['addr']}})</span>
										</span>
												...
												<li class="td td-item">
													<div class="item-pic">
														<a href="#" class="J_MakePoint">
															<img class="img" src="{{asset($v->gpic)}}" class="itempic J_ItemImg"></a>
													</div>
													<div class="item-info">
											...
											<li class="td td-amount">
												<div class="amount-wrapper ">
													<div class="item-amount ">
														...
														<div class="sl">
															<div class="price-content">
															<em class="J_Price price-now">{{$v->num}}</em>
														</div>
														</div>
													</div>
												</div>
						...
						<!--留言-->
							...
							<div class="buy-point-discharge ">
								<p class="price g_price ">
									合计<span>¥</span><em class="pay-sum"></em>
								</p>
							</div>
