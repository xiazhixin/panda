			...
			<div class="nav white">
				...
				<div class="search-bar pr">
					...
					<form action="{{url('home/list')}}" method="get">
						<input id="searchInput" name="keywords" type="text" placeholder="关键字" autocomplete="on" value="{{$input}}">
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">	
									...
									<li>
										<div class="i-pic limit">
											...
											<p class="title fl">{{$goods[$k]['gname']}}</p>
											<p class="price fl">
												<b>¥</b>
												<strong>56.90</strong>
											</p>
					...
					<div id="prof" class="item">
						...
						<div class="ibar_login_box status_login">
							<div class="avatar_box">
								<p class="avatar_imgbox"><img src="{{asset('home/jq22/fudong/images/no-img_mid_.jpg')}}" /></p>
								<ul class="user_info">
									<li>用户名：sl1903</li>
									<li>级&nbsp;别：普通会员</li>
								</ul>
