    ...
    <div id="mws-login-wrapper">
        ...
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="{{url('doforget')}}" method="post">
                    {{csrf_field()}}
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <input type="text" name="uname" class="mws-login-username required" placeholder="请输入账号"value="">
                        </div>
                    </div>

                    <div class="mws-form-row">
                        <input type="submit" value="确认找回" class="btn btn-success mws-login-button">
                    </div>
                </form>
            </div>
        </div>
