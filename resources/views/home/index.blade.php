	...
	<div class="am-container header">
		...
		<ul class="message-r">
			...
			<div class="topMessage mini-cart">
				<div class="menu-hd"><a id="mc-menu-hd" href="home/docart" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div>
			</div>
...
@endsection
		...
		<div class="navCir">
			...
			<li><a href="{{url('home/docart')}}"><i class="am-icon-shopping-basket"></i>购物车</a></li>
