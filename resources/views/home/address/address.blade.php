					...
					<div class="user-address">
                        ...
                        @endif
								...
								<p class="new-tit new-p-re">
									...
									<span class="new-txt-rd2">{{ substr_replace($v->tel,'****',3,4) }}</span>
								</p>
								...
								<div class="new-addr-btn">
									<a href="javascript:void(0);" onclick="javascript:window.location.href='{{ url('/home/address') }}/{{ $v->id }}/edit'" ><i class="am-icon-edit"></i>编辑</a>
									<span class="new-addr-bar">|</span>
									<a href="javascript:void(0);" onclick="doDel({{$v->id}})" class="del"><i class="am-icon-trash"></i>删除</a>
								</div>
							</li>
                        @endforeach
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form action="{{url('/home/address/store')}}" method="post" class="am-form am-form-horizontal">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="uid" value="{{ session('user')->uid }}">
										<div class="am-form-group">
											<label for="user-name" class="am-form-label">收货人：</label>
											<div class="am-form-content">
												<input type="text" name="rec" value="" id="user-name" placeholder="收货人">
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input id="user-phone" name="tel" value="" placeholder="手机号" type="text">
											</div>
										</div>
										<div class="am-form-group">
											<label for="user-address" class="am-form-label">所在地：</label>
											<div class="am-form-content">
												<input id="user-phone" name="addr" value="" placeholder="收货地址" type="text">
											</div>
										</div>
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<button type="submit" class="am-btn am-btn-danger">保存</button>
												<a href="javascript: void(0)" onclick="history.go(-1)" class="am-close am-btn am-btn-danger" data-am-modal-close>取消</a>
											</div>
										</div>
									</form>
								</div>
