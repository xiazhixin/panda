					...
					<div class="wrap-left">
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-right">
										...
										<div class="m-address">
											<a href="{{url('home/address')}}" class="i-trigger">收货地址</a>
										</div>
									</div>
								</div>
								...
								<div class="m-userproperty">
									...
									<p class="m-bonus">
										<a href="">
											<i><img src="{{asset('centerstyle/images/bonus.png')}}"/></i>
									...
									<p class="m-coupon">
										<a href="">
											<i><img src="{{asset('centerstyle/images/coupon.png')}}"/></i>
									...
									<p class="m-bill">
										<a href="">
											<i><img src="{{asset('centerstyle/images/wallet.png')}}"/></i>
									...
									<p class="m-big">
										<a href="">
											<i><img src="{{asset('centerstyle/images/day-to.png')}}"/></i>
											<span class="m-title">签到有礼</span>
										</a>
									</p>
									<p class="m-big">
										<a href="">
											<i><img src="{{asset('centerstyle/images/72h.png')}}"/></i>
							...
							<div class="m-order">
								...
								<ul>
									<li><a href="{{url('/home/order')}}"><i><img src="{{asset('centerstyle/images/pay.png')}}"/></i><span>待付款</span></a></li>
									<li><a href="{{url('/home/order')}}"><i><img src="{{asset('centerstyle/images/send.png')}}"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="{{url('/home/order')}}"><i><img src="{{asset('centerstyle/images/receive.png')}}"/></i><span>待收货</span></a></li>
									<li><a href="{{url('/home/order')}}"><i><img src="{{asset('centerstyle/images/comment.png')}}"/></i><span>待评价<em class="m-num">3</em></span></a></li>
