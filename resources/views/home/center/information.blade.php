...
<html>
	...
	<head>
		...
		<script src="{{asset('centerstyle/js/jquery.js')}}" type="text/javascript"></script>
		<script src="{{asset('centerstyle/js/amazeui.js')}}" type="text/javascript"></script>
			...
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="user-info">
						...
						<hr/>
                         <form class="am-form am-form-horizontal" id="art_form" action="{{url('/home/center/update')}}/{{session('user')->uid}}" method="post">
						...
						<div class="user-infoPic">
							...
							<div style="hight:500px;" class="filePic">
								...
								<img style="height:100px;" id="img1" class="am-circle am-img-thumbnail" src="/{{ session('user')->photo }}" />
...
//                            判断是否有选择上传文件
						...
						<div class="info-main">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input type="text" value="{{ session('user')->uname }}" name="uname" placeholder="姓名">
								...
								<div class="am-form-group">
									...
									<div class="am-form-content">
										<input id="user-phone" value="{{ session('user')->phone }}" name="tel" placeholder="电话" type="tel">
