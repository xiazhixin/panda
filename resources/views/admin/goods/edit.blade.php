                        ...
                        <div class=" form">
                            <form id="goods_form" class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{url('admin/goods/'.$goods->gid)}}" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">*商品分类:</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <input class=" form-control" id="cname" name="gname" minlength="2" type="text" required value="{{$goods->gname}}" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="cemail" class="control-label col-lg-2">商品价格:</label>
                                    <div class="col-lg-10">
                                        <input class="form-control " id="cemail" type="text" name="price" required value="{{$goods->price}}" />
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="curl" class="control-label col-lg-2">库　　存:</label>
                                    <div class="col-lg-10">
                                        <input class="form-control " id="curl" type="text" name="stock" value="{{$goods->stock}}"/>
                                    </div>
                                </div>
                                <div class="form-group ">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea class="form-control " id="ccomment" name="gdesc" required placeholder="{{$goods->gdesc}}"></textarea>
                                    </div>
                                </div>
                                <div class="form-group ">
