            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form id="goods_form" class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{url('admin/goods')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <select name="cate_name">
                                                ...
                                                @foreach($cates as $v)
                                                <option value="{{$v->cate_name}}">{{str_repeat("　",2*$v->lev).'|--'.$v->cate_name}}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">*商品品牌:</label>
                                    <div class="col-lg-10">
                                        <input class=" form-control" id="cname" name="brand_name" minlength="2" type="text" required />
                                    </div>
                                </div>
                                <div class="form-group ">
