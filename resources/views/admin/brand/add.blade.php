            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class=" form">
                            <form id="goods_form" class="cmxform form-horizontal tasi-form" id="commentForm" method="post" action="{{url('admin/brand')}}" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-2">*商品分类:</label>
                                    <div class="col-lg-10">
                                        <select name="brand_cate_id">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea class="form-control " id="ccomment" name="brand_description" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
